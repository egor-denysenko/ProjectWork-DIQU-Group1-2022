...
# 19 "mainTrainControl.c" 2
# 47 "mainTrainControl.c"
void LCDInit();
...
void initSerial(unsigned long int baudRate)
{
 ...
 SPBRG = (char) (8000000/(long) (64UL*baudRate)) - 1;
}
